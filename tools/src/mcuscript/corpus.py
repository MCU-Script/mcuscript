...
def _cases() -> list[Case]:
    ...
    def case(name, stage, refusal, description, blob, host=""):
        cases.append(Case(name, stage, refusal, description, blob, host))
...
def manifest() -> str:
    ...
    out = [
        ...
        "#",
        "# Each case is a container and the verdict a conforming loader",
        "# must give it. See README.md in this directory.",
        "#",
